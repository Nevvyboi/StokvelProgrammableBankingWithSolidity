...
/// @title StokvelV1Vulnerable
/// @notice Version one, kept for the talk. Never deploy it: it trusts the relayer not to repeat itself.
contract StokvelV1Vulnerable is IStokvel, EIP712 {
    struct Payout {
        uint8 memberId;
        bool settled;
        uint256 cents;
